                ...
                <div className="projects-description">
                    <div className="projects-description-content">
                        <p>
                            ...
                            collaboration avec des référenceurs, graphistes et photographes pour donner vie à un projet dans sa globalité.
                        </p>
                        <p>
                            N'hésitez pas à consulter également les prototypes - ou <strong>"mockups"</strong>- de sites, qui sont des inspirations sur
                            différents thèmes.
                        </p>
                    </div>
                    <RealisationImage />
